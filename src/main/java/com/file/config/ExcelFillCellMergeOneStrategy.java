...
@Data
public class ExcelFillCellMergeOneStrategy implements CellWriteHandler {
    /**
    ...
    public ExcelFillCellMergeOneStrategy() {
    }

    public ExcelFillCellMergeOneStrategy(int mergeRowIndex, int[] mergeColumnIndex) {
